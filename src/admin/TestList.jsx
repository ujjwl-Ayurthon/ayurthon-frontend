...
export default function TestList() {
  ...
  useEffect(() => {
    ...
    api.get('/api/tests/channels/list')
      .then(r => {
        ...
        if (r.data.channels.length > 0) setSelectedCh(r.data.channels[0].id)
      })
      .catch(() => {})
  }, [])
  ...
  async function confirmPublish() {
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: `✅ Published! Telegram: ${res.data.telegram_sent ? '✅ Sent' : '⚠️ Failed'}`
      })
      setModal(null)
      fetchTests()
    } catch (err) {
    ...
    <div>
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th>Duration</th><th>Status</th><th>Telegram</th><th>Actions</th>
                </tr>
              </thead>
              <tbody>
                {tests.map(t => (
      ...
      {modal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.6)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
          <div className="card" style={{ maxWidth: '480px', width: '100%', position: 'relative', maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            <div className="form-group">
              ...
              <select className="form-control" value={selectedCh} onChange={e => setSelectedCh(e.target.value)}>
            ...
            <div style={{ background: '#1A1A2E', borderRadius: '10px', padding: '16px', marginBottom: '20px' }}>
              ...
              <div style={{ color: 'white', fontSize: '0.85rem', lineHeight: '1.8', whiteSpace: 'pre-wrap' }}>
...
📊 Result & Leaderboard milega!`}
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <button className="btn btn-success btn-full btn-lg" onClick={confirmPublish} disabled={publishing || !selectedCh}>
