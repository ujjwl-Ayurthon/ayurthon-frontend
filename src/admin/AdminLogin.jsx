...
function extractAdminToken(data) {
  if (!data) return "";
  return data.token || data.adminToken || data.admin_token
...
function AdminLogin() {
  ...
  // NO useEffect redirect here — causes loop when navigating back
  // Dashboard handles its own auth guard
  ...
  function handleLogin() {
    ...
    apiFetch("/api/admin/login", {
      ...
      if (result.status === 0) {
        setError("Server se connect nahi ho pa raha. Render backend 30 sec mein wake-up hoga — dobara try karo.");
        return;
      }
  ...
  var cardStyle = {
    ...
    borderRadius: "24px",
    boxShadow: "0 24px 64px rgba(13,148,136,0.12)",
  ...
  return (
    <div style={pageStyle}>
      <div style={{ position: "fixed", top: "-100px", left: "-100px", width: "450px", height: "450px", borderRadius: "50%", background: "radial-gradient(circle,rgba(13,148,136,0.10) 0%,transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "fixed", bottom: "-80px", right: "-80px", width: "380px", height: "380px", borderRadius: "50%", background: "radial-gradient(circle,rgba(212,175,55,0.09) 0%,transparent 70%)", pointerEvents: "none" }} />
      ...
      <div style={cardStyle}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <div style={{ fontFamily: "Georgia,serif", fontWeight: "700", fontSize: "20px", color: "#0f172a" }}>AYURTHON</div>
        ...
        <div>
          <label style={{ fontSize: "11px", fontWeight: "700", color: "#475569", marginBottom: "6px", display: "block", letterSpacing: "0.5px", textTransform: "uppercase" }}>Admin Password</label>
