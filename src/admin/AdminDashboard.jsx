        ...
        {!result ? (
          <>
            <div style={{ background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.22)", borderRadius: "12px", padding: "12px 16px", display: "flex", gap: "10px", alignItems: "flex-start", marginBottom: "24px" }}>
              ...
              <p style={{ fontSize: "12px", color: "#92400e", margin: "0", lineHeight: "1.6" }}>Ek random password generate hoga. Purana password turant invalid ho jaega. Yeh password student ko share karna hoga.</p>
            </div>
          ...
          <>
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              ...
              <p style={{ fontSize: "14px", color: "#475569", margin: "0 0 4px" }}>Password reset ho gaya!</p>
              <p style={{ fontSize: "12px", color: "#94a3b8", margin: "0" }}>Student ko yeh share karo:</p>
            </div>
            <div style={{ background: "rgba(13,148,136,0.06)", border: "1.5px solid rgba(13,148,136,0.22)", borderRadius: "12px", padding: "16px", marginBottom: "12px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
...
function StudentManagement() {
  ...
  var errS   = useState(null); var errorInfo = errS[0]; var setErrorInfo = errS[1];
  var srchS  = useState("");   var search = srchS[0]; var setSearch = srchS[1];
  var rstS   = useState(null); var resetStudent = rstS[0]; var setResetStudent = rstS[1];
      ...
      <div style={{ padding: "20px 24px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", flexWrap: "wrap", borderBottom: "1px solid rgba(226,232,240,0.60)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "11px", color: "#64748b" }}>{loading ? "Loading..." : students.length + " registered students"}</div>
          </div>
        </div>
              ...
              {filtered.map(function(s, idx) {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={td}>
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: s.avatar_color || "linear-gradient(135deg,#0D9488,#D4AF37)", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontWeight: "700", fontSize: "13px", flexShrink: 0 }}>
                          {(s.name || s.telegram_username || "?").charAt(0).toUpperCase()}
                        </div>
                    ...
                    <td style={td}>
                      <span style={{ display: "inline-block", padding: "3px 10px", borderRadius: "99px", fontSize: "11px", fontWeight: "700", background: active ? "rgba(13,148,136,0.10)" : "rgba(225,29,72,0.08)", color: active ? "#0D9488" : "#be123c", border: "1px solid " + (active ? "rgba(13,148,136,0.22)" : "rgba(225,29,72,0.18)") }}>
                        {active ? "Active" : "Inactive"}
                      </span>
                    </td>
                    <td style={Object.assign({}, td, { textAlign: "center" })}>
                      <button onClick={function() { setResetStudent(s); }}
