...
function adminHeaders() {
  return {
    ...
    "ayurthon_admin_token": getAdminToken(),
...
function ResetPasswordModal(props) {
  ...
  function handleReset() {
    ...
    fetch(API_URL + "/api/students/" + student._id + "/reset-password", {
      ...
      .then(function(data) {
        setLoading(false);
        if (data.success && (data.new_password || data.temporaryPassword)) {
          setResult(data.new_password || data.temporaryPassword);
        } else {
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          <h2 style={{ fontFamily: "Georgia,serif", fontSize: "18px", fontWeight: "700", color: "#0f172a", margin: "0 0 6px" }}>
            Reset Password
          </h2>
          ...
          <>
            ...
            >
              ...
              <p style={{ fontSize: "12px", color: "#92400e", margin: "0", lineHeight: "1.6" }}>
                Ek random password generate hoga. Purana password immediately invalid ho jaega. Yeh password student ko share karna hoga.
              </p>
            </div>
            {error && (
              <div
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: "11px",
                  border: "none",
                  background: loading ? "#94a3b8" : "linear-gradient(135deg,#D4AF37,#b8941f)",
                  color: "#0f172a",
                  fontSize: "14px",
                  fontWeight: "700",
                  cursor: loading ? "not-allowed" : "pointer",
                  boxShadow: loading ? "none" : "0 6px 18px rgba(212,175,55,0.35)",
                }}
              >
            ...
            >
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                <button
                  onClick={handleCopy}
                  style={{
                    background: copied ? "rgba(13,148,136,0.12)" : "rgba(241,245,249,0.80)",
                    border: "none",
                    borderRadius: "8px",
                    width: "32px",
                    height: "32px",
...
function StudentManagement(props) {
  ...
  var fetchStudents = props.onRefresh;
              ...
              {filtered.map(function(student, idx) {
                return (
                  ...
                  >
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        <div
                          style={{
                            ...
                            height: "32px",
                            borderRadius: "50%",
                            background: student.avatar_color || "linear-gradient(135deg,#0D9488,#D4AF37)",
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                            color: "white",
                    ...
                    <td style={Object.assign({}, tdStyle, { color: "#64748b" })}>{formatDate(student.createdAt || student.joined_at)}</td>
                    <td style={tdStyle}>
                      <span style={{ fontWeight: "700", color: "#0f172a" }}>{(student.attempts && student.attempts.length) || 0}</span>
                    </td>
                    <td style={tdStyle}>
                      <span
                        style={{
  ...
  return (
    <GlassCard style={{ padding: "20px 24px" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
        <div style={{ fontSize: "12px", fontWeight: "600", color: "#64748b", textTransform: "uppercase", letterSpacing: "0.6px" }}>
          {props.label}
        </div>
        <div
          style={{
            ...
            height: "36px",
            borderRadius: "10px",
            background: props.iconBg || "rgba(13,148,136,0.10)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
...
function AdminDashboard() {
  ...
  // Pipeline configuration for students storage sync
  var studentsState = useState([]);
  var students = studentsState[0];
  var setStudents = studentsState[1];
  var studentsLoadingState = useState(true);
  var studentsLoading = studentsLoadingState[0];
  var setStudentsLoading = studentsLoadingState[1];
  var studentsErrorState = useState("");
  var studentsError = studentsErrorState[0];
  var setStudentsError = studentsErrorState[1];
  ...
  function fetchStudentsList() {
    ...
    fetch(API_URL + "/api/students", { headers: adminHeaders() })
      ...
      .then(function(data) {
        ...
        var cleanArray = data.students || data.data || (Array.isArray(data) ? data : []);
        setStudents(cleanArray);
      })
      .catch(function() {
        setStudentsLoading(false);
        setStudentsError("Server Connectivity fail ho gayi.");
      });
  }
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "9px",
                    border: "none",
                    background: activeTab === tab.id ? "rgba(13,148,136,0.12)" : "transparent",
        ...
        {activeTab === "overview" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "16px", marginBottom: "28px" }}>
              ...
              <StatCard label="Total Students" value={students.length} loading={studentsLoading} icon={Users} iconBg="rgba(34,197,94,0.10)" iconColor="#16a34a" sub="Registered Users" />
            </div>
                      ...
                      >
                        <div>
                          ...
                          <div style={{ fontSize: "12px", color: "#64748b" }}>
                            {test.questions ? test.questions.length : "?"} Questions · {test.duration_minutes} min · +{test.correct_marks}/−
                            {test.negative_marks}
                          </div>
                        </div>
                        <span
